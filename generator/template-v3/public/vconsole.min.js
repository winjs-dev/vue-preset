                              ...
                              if (
                                ...
                                for (
                                  ...
                                  n.isFunction(t[c])
                                    ...
                                    : n.isObject(t[c]) || n.isArray(t[c])
                                    ? l.logText.push(n.JSONStringify(t[c]))
                                    : l.logText.push(t[c]);
                                (l.logText = l.logText.join(' ')),
                                  l.hasContent ||
                                  h.logType !== l.logType ||
                                  h.logText !== l.logText
                                    ? (this.printNewLog(e, t), (h = l))
                                    : this.printRepeatLog(),
                                  this.isInBottom &&
                                    this.isShow &&
                        ...
                        value: function (e, t) {
                          ...
                          if (n.isString(t[0]) && i.test(t[0])) {
                            for (
                              ...
                              n.isString(t[u + 1]) && l.push(t[u + 1]);
                            for (var v = s.length + 1; v < t.length; v++)
                              c.push(t[v]);
                            t = c;
                          }
                          for (
                            var f = r.default.one('.vc-item-content', o), p = 0;
                            p < t.length;
                            p++
                          ) {
                            var b = void 0;
                            try {
                              ...
                              b = n.isFunction(t[p])
                                ...
                                : n.isObject(t[p]) || n.isArray(t[p])
                                ? this.getFoldedLine(t[p])
                                : (l[p]
                                    ? '<span style="'.concat(l[p], '"> ')
                                    : '<span> ') +
                                  n.htmlEncode(t[p]).replace(/\n/g, '<br/>') +
                                  '</span>';
                            } catch (e) {
                              b = '<span> [' + d(t[p]) + ']</span>';
                            }
                          ...
                          n.isObject(e.content) &&
                            f.insertAdjacentElement('beforeend', e.content),
                            r.default
          ...
          (i =
            ...
            typeof (n = function (o, n, r) {
              ...
              Object.defineProperty(o, '__esModule', { value: !0 }),
                (o.default = void 0);
              var i,
                a = ((i = r), (r = i && i.__esModule ? i : { default: i }))
                  .default;
                    ...
                    if (
                      ...
                      if (void 0 !== document)
                        'loading' === document.readyState
                          ? i.default.bind(window, 'DOMContentLoaded', c)
                          : c();
                      else
              ...
              var v = (function (e) {
                function t() {
                  ...
                  return (
                    ((o = c(
                      this,
                      (e = d(t)).call.apply(e, [this].concat(i))
                    )).tplTabbox = r.default),
                  ...
                  (i = [
                    {
                      key: 'onInit',
                      value: function () {
                        s(d(t.prototype), 'onInit', this).call(this),
                      ...
                      value: function (e, t) {
                        ...
                        if (((this.reqList[e] = i), this.isReady)) {
                          ...
                          i.status >= 400 &&
                            ...
                            (this.domList[e] = s),
                            Object.keys(this.reqList).length != o &&
                              this.renderHeader(),
                          ...
                          (e._open = t),
                              ...
                              var c = o.onreadystatechange || function () {},
                                s = function () {
                                  ...
                                  if (
                                    ...
                                    (t.status = 0),
                                    o.readyState > 1 && (t.status = o.status),
                                    (t.responseType = o.responseType),
                                    0 == o.readyState)
                                  )
                                    t.startTime || (t.startTime = +new Date());
                                  else if (1 == o.readyState)
                                    t.startTime || (t.startTime = +new Date());
                                    ...
                                    3 == o.readyState ||
                                      (4 == o.readyState
                                        ...
                                        : clearInterval(l));
                                  return (
                                    o._noVConsole || e.updateRequest(a, t),
                                    c.apply(o, arguments)
                                  );
                                };
                            ...
                            (window.XMLHttpRequest.prototype.send = function () {
                              ...
                              if (((a.url = l.shift()), l.length > 0)) {
                                ...
                                try {
                                  for (
                                    var u, v = l[Symbol.iterator]();
                                    !(c = (u = v.next()).done);
                                    c = !0
                                  ) {
                                    var f = u.value;
                                    (f = f.split('=')),
                                      (a.getData[f[0]] = decodeURIComponent(
                                        f[1]
                                      ));
                                  }
                                } catch (e) {
            ...
            typeof (n = function (o, n, r, i, a, l, c) {
              ...
              var b = (function (e) {
                function t() {
                  ...
                  (n = this),
                    (o =
                      !(r = (e = v(t)).call.apply(e, [this].concat(l))) ||
                        ...
                        e([
                          {
                            ...
                            onClick: function (e) {
                              if (t.activedElem)
                                if (
                                  c.default.hasClass(t.activedElem, 'vc-toggle')
                                )
                                  for (
                                    var o = 0;
                      ...
                      value: function (e) {
                        ...
                        if (t.__vconsole_node) {
                          for (var o = 0; o < e.removedNodes.length; o++) {
                            ...
                            n &&
                              n.view &&
                              n.view.parentNode.removeChild(n.view);
                          }
                          this.getNode(t);
                        }
                      }
